...
export const ACTIVE_REGISTRATION_STATUSES = [
  ...
  'STT_ISSUED', 'DOCUMENTATION_IN_PROGRESS', 'PHYSICAL_HANDOVER_CORRECTION_REQUIRED',
];

export const REGISTRATION_SEGMENTS = {
  PUBLISHER_ACTIONS: ['DRAFT', 'REVISION_REQUIRED', 'AWAITING_PAYMENT', 'PHYSICAL_HANDOVER_CORRECTION_REQUIRED'],
