...
- FIFO menentukan urutan tampilan/prioritas; tidak otomatis menugaskan atau
  ...
  *(Catatan: Penambahan role HELPER_ADMIN serta kewenangan intake fisik dan penugasan tim pentashihan telah diimplementasikan pada migrasi berikutnya `20260916140000_add_admin_role`, lihat `docs/admin-rbac.md`)*.
