        ...
        switch (userRole) {
            ...
            case "VERIFICATOR":
                return {
                    ...
                    color: "bg-brand-50 text-brand-900 border-brand-100",
                };
            case "DISTRIBUTOR":
                return {
                    label: "Koordinator Distribusi",
                    color: "bg-brand-50 text-brand-900 border-brand-100",
                };
            case "PENTASHIH":
            case "TASHIH_MEMBER":
                return {
                    label: "Pentashih Naskah",
                    color: "bg-brand-50 text-brand-900 border-brand-100",
                };
            case "DOKUMENTATOR":
            case "DOCUMENTATOR":
                return {
                    label: "Administrator Dokumen",
                    color: "bg-brand-50 text-brand-900 border-brand-100",
                };
            case "KEPALA_LPMQ":
            case "HEAD_OF_LPMQ":
            ...
            case "PUBLISHER":
                return {
                    label: "Penerbit Terverifikasi",
                    color: "bg-slate-100 text-slate-800 border-slate-300",
                };
            default:
                return {
                    label: userRole || "Petugas",
                    color: "bg-slate-100 text-slate-800 border-slate-300",
                };
        }
    };
                    ...
                    <div className="flex items-center justify-between h-full">
                        ...
                        <div className="flex items-center gap-2.5 sm:gap-3.5 min-w-0">
                            ...
                            <nav
                                ...
                                className="hidden sm:flex items-center text-xs text-ink-muted min-w-0"
                            >
                            ...
                            {currentUser && (
                                <div className="relative" ref={dropdownRef}>
                                    ...
                                    >
                                        ...
                                        <ChevronDown
                                            className={`w-3.5 h-3.5 text-ink-muted transition-transform ${profileDropdownOpen ? "rotate-180" : ""}`}
                                        />
                                    </button>
                                    ...
                                    {profileDropdownOpen && (
                                        <div className="absolute right-0 mt-2 w-64 bg-surface rounded-xl shadow-xl border border-line py-1.5 z-50 animate-slideUp">
                                            <div className="px-3.5 py-2.5 border-b border-line">
                                                ...
                                                <div className="mt-2">
                                                    <span
                                                        className={`inline-flex items-center gap-1 text-[11px] font-semibold px-2 py-0.5 rounded border ${roleConfig.color}`}
                                                    >
                                            ...
                                            <div className="px-3.5 py-2 bg-surface-subtle/70 border-b border-line text-[11px] text-ink-muted">
                                                Kontrol proses mengacu pada SOP
                                                v2.2
                                            </div>
