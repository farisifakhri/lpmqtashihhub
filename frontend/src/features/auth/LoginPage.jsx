...
export const LoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (res.success) {
            const isPublisher =
                res.user.roles?.includes("ADMIN_PENERBIT") ||
                res.user.role === "ADMIN_PENERBIT";
            const defaultTarget = isPublisher ? "/publisher" : "/internal";
            const redirectTarget =
                location.state?.from?.pathname || defaultTarget;
            navigate(redirectTarget, { replace: true });
        } else {
            setError(
                res.error ||
                    "Autentikasi gagal. Periksa email atau kata sandi Anda.",
            );
        }
    };
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 items-stretch">
                        ...
                        <div className="relative z-10 p-5 sm:p-5 bg-gradient-to-t from-neutral-900/60 via-neutral-900/20 to-transparent pt-12">
                            <div className="bg-green-600/50 backdrop-blur-sm p-4 rounded-2xl border border-white/30 text-white shadow-sm">
                                <p className="text-xs font-semibold text-emerald-100 flex items-center gap-1.5 mb-0.5">
                                    ...
                                    SIPNA (Sistem Informasi Pentashih Naskah
                                    Quran)
                                </p>
                                <h3 className="text-sm sm:text-base font-bold text-white leading-snug">
                                    Sistem Informasi Pentashihan Naskah
                                    Al-Qur'an (SIPNA) - LPMQ Kementerian Agama
                                    RI
                                </h3>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-6 flex flex-col justify-between px-5 py-6 sm:px-8 sm:py-8 lg:px-12 lg:py-10">
                            ...
                            <div className="text-center sm:text-left space-y-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs sm:text-sm text-neutral-500 mt-1">
                                        Gunakan akun resmi untuk mengakses
                                        layanan pengajuan, verifikasi, dan
                                        pengendalian proses.
                                    </p>
                                </div>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="flex justify-end pt-0.5">
                                    <span className="text-xs text-neutral-500">
                                        Hubungi administrator apabila akses
                                        terkunci.
                                    </span>
                                </div>
                        ...
                        <div className="pt-6 text-center text-[11px] text-neutral-400">
                            Lajnah Pentashihan Mushaf Al-Qur'an &copy; 2026
