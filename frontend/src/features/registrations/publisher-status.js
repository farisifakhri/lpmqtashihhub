...
export const publisherAction = registration => {
  ...
  if (registration.status === 'REVISION_REQUIRED') return { label: 'Unggah perbaikan', description: 'Baca catatan petugas, unggah versi terbaru, lalu ajukan ulang.', path: `/publisher/registrations/${registration.id}` };
